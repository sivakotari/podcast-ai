      ...
      <Sheet>
        ...
        >
          <Link href="/" className='flex cursor-pointer items-center gap-1 pb-10 pl-4'>
            ...
            <h1 className='text-24 font-extrabold text-white-1 ml-2'>Podcast AI</h1>
          </Link>
                ...
                {sidebarLinks.map(({ route, label, imgURL }) => {
                  ...
                  return (
                    <SheetClose asChild key={route}>
                      <Link key={label} href={route} className={cn('flex gap-3 items-center py-4 max-lg:px-4 justify-start', {
